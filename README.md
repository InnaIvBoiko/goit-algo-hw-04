...
### Результати порівняльного аналізу алгоритмів сортування

Було проведено емпіричне дослідження трьох алгоритмів сортування: сортування злиттям (Merge Sort), сортування вставками (Insertion Sort) та вбудованого алгоритму Python Timsort на різних типах даних та розмірах масивів.

![Результати тестування алгоритмів сортування](assets/Screenshot%202025-11-24%20alle%2017.57.03.png)

![Найшвидший алгоритм по сценаріям](assets/Screenshot%202025-11-24%20alle%2017.57.21.png)

### Основні висновки:

1. **Timsort демонструє найкращу продуктивність у всіх сценаріях:**

   - На випадкових даних Timsort показав найкращі результати для всіх розмірів масивів (100, 1000, 5000, 10000 елементів)
   - На вже відсортованих даних Timsort також виявився найшвидшим
   - На зворотно відсортованих даних Timsort знову показав найкращі результаты

2. **Сортування злиттям (Merge Sort) показало стабільну продуктивність:**

   - Має гарантовану складність O(n log n) у всіх випадках
   - Працює передбачувано незалежно від початкового порядку елементів
   - Значно випереджає сортування вставками на великих масивах

3. **Сортування вставками (Insertion Sort) показало найгіршу продуктивність:**

   - На великих масивах (10000 елементів) алгоритм працював занадто повільно
   - Має складність O(n²) в найгіршому випадку
   - Ефективний лише на невеликих масивах або майже відсортованих даних

4. **Перевага гібридного підходу Timsort:**
   - Timsort поєднує найкращі властивості сортування злиттям та вставками
   - Адаптується до особливостей вхідних даних (частково відсортовані послідовності)
   - Оптимізований для реальних сценаріїв використання

Результати емпірично підтверджують, що поєднання різних алгоритмічних підходів у Timsort робить його значно ефективнішим за окремі алгоритми, що пояснює, чому програмісти віддають перевагу вбудованим функціям сортування Python.
